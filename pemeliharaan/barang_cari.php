  ...
  <tr>
	...
	?>
        <tr bgcolor="<?php echo $warna; ?>">
          ...
          <td><a href="#" onClick="window.opener.document.getElementById('txtKodeID').value = '<?php echo $myData['kd_inventaris']; ?>'; 
				  						window.opener.document.getElementById('txtNamaBrg').value = '<?php echo $myData['nm_barang']; ?>';
										window.opener.document.getElementById('txtNomorSeri').value = '<?php echo $myData['nomor_seri']; ?>';
