...
<table width="1400" border="0" cellpadding="2" cellspacing="1" class="table-border">
  ...
  <tr>
	...
	for ($h = 1; $h <= $max; $h++) {
		$list[$h] = $row * $h - $row;
		echo " <a href='?open=Laporan-Inventaris-Barang-2&hal=$list[$h]&kodeKategori=$dataKategori'>$h</a> ";
	}
	?></td>
          </tr>
      </table></td>
...
<a href="cetak/inventaris_barang_2.php?kodeKategori=<?php echo $dataKategori; ?>" target="_blank"><img src="images/btn_print2.png" height="18" border="0" title="Cetak ke Format HTML"/></a>
<?php
# Penutup Hak Akses
}
else {
