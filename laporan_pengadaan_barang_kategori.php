...
<a href="cetak/pengadaan_barang_kategori.php?kodeKategori=<?php echo $dataKategori; ?>&tahun=<?php echo $dataTahun; ?>" target="_blank"><img src="images/btn_print2.png" height="18" border="0" title="Cetak ke Format HTML"/></a>
<?php
# Penutup Hak Akses
}
else {
